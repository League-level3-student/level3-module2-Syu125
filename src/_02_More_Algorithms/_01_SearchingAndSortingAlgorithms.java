...
public class _01_SearchingAndSortingAlgorithms {
	...
	public void testSearch() {
		...
		assertEquals(Algorithms.findBrokenEgg(eggs),2);
	}
	...
	public void testSearchAndAccumulate() throws Exception {
		...
		assertEquals(Algorithms.countPearls(oysters),2);
	...
	public void testFindMaxiumum() throws Exception {
		...
		assertEquals (Algorithms.findTallest(peeps),6.6);
		System.out.println(Algorithms.findTallest(peeps));
	}
